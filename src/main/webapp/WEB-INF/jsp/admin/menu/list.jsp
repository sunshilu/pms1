...
<div class="layui-collapse">
		<div class="layui-colla-item">
			<h2 class="layui-colla-title">菜单信息维护</h2>
					...
					<form class="layui-form">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="code" placeholder="请输入菜单编号"
	...
	<script type="text/javascript">
	 upload.render({ //允许上传的文件后缀
		...
		function openUserAdd() {
			openLayer(con.jsp_url+"/WEB-INF/jsp/admin/menu/add", refresh)
		}
		function openUserUpd(code) {
			openLayer(con.jsp_url+"/WEB-INF/jsp/admin/menu/upd&code="+ code,
					refresh)
		}
