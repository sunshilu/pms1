...
<div class="layui-collapse">
		<div class="layui-colla-item">
			<h2 class="layui-colla-title">角色信息维护</h2>
	...
	<script type="text/javascript">
	 upload.render({ //允许上传的文件后缀
		...
		function openUserAdd() {
			openLayer(con.jsp_url+"/WEB-INF/jsp/admin/role/add", refresh)
		}
		function openUserUpd(code) {
			openLayer(con.jsp_url+"/WEB-INF/jsp/admin/role/upd&code="+ code,
					refresh)
		}
