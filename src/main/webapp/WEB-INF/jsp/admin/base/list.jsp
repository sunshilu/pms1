...
<div class="layui-collapse">
		<div class="layui-colla-item">
			<h2 class="layui-colla-title">基础数据维护</h2>
			<div class="layui-colla-content layui-show">
				<fieldset class="layui-elem-field layui-field-title"
					style="margin-top: 0px; padding: 5px">
					<legend>基础数据信息-查询条件</legend>
	 ...
	 upload.render({ //允许上传的文件后缀
		...
		function refresh() {
			 table.render({
				    ...
				    ,height: 312
				    ,cellMinWidth: 80
				    ,url: con.app+'/baseData/search' //数据接口
				    ,page: true //开启分页
				    ,limit:5
				    ...
				    ,cols: [[ //表头
				      ...
				      ,{field: 'code', title: '数据编号', sort: true}
		...
		function openUserAdd() {
			openLayer(con.jsp_url+"/WEB-INF/jsp/admin/base/add", refresh)
		}
		function openUserUpd(code) {
			openLayer(con.jsp_url+"/WEB-INF/jsp/admin/base/upd&code="+ code,
					refresh)
		}
