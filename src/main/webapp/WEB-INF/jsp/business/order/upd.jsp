		...
		<form class="layui-form" lay-filter="upduser" method="post">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="userCode" readonly lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="customerCode" readonly lay-verify="required"
						placeholder="请输入" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="productCode" readonly lay-verify="required"
						placeholder="请输入" autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
...
function init(){
    ...
    var code = '<%=request.getParameter("code")%>';
		...
		formSubmit('/order/upd', 'submit(updUser)', 'text',
				function(data) {
					if (data == 1) {
						layer.msg('修改成功');
						closeThis(1000);
