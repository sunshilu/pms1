...
<div class="layui-collapse">
		<div class="layui-colla-item">
			<h2 class="layui-colla-title">沟通记录维护</h2>
			<div class="layui-colla-content layui-show">
				<fieldset class="layui-elem-field layui-field-title"
					style="margin-top: 0px; padding: 5px">
					<legend>沟通信息-查询条件</legend>
					<form class="layui-form">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="customerCode" placeholder="请输入姓名"
									autocomplete="off" class="layui-input">
							</div>
	 ...
	 upload.render({ //允许上传的文件后缀
		...
		function refresh() {
			 table.render({
				    elem: '#demo'
				    ,height: 312
				    ,url: con.app+'/communication/search' //数据接口
				    ,page: true //开启分页
				    ,limit:5
				    ...
				    ,cols: [[ //表头
				      ...
				      ,{title: '用户名',templet:"<div>{{d.customerModel.name}}</div>"}
				      ,{field: 'time', title: '时间'} 
				      ,{field: 'type', title: '类别'}
		...
		function openUserAdd() {
			openLayer(con.jsp_url+"/WEB-INF/jsp/business/communication/add", refresh)
		}
		function openUserUpd(code) {
			openLayer(con.jsp_url+"/WEB-INF/jsp/business/communication/upd&code="+ code,
					refresh)
		}
		function delUser(code) {
			openConfirm(function(index) {
				ajax('/communication/del', {
					code : code
				}, 'text', function(data) {
					console.log(data);
					if (data == 1) {
